# Q7-Q8 problem-solving standard
...
- Increase demand through one or two purposeful features, such as:
  ...
  - add one meaningful condition;
  - use a table, graph, diagram or model to make a prediction;
  - reconcile equivalent representations;
  - apply a familiar relationship in a less obvious case.
- Preserve a response routine students have practised.
...
Tell students what result to produce, not how to solve it. Keep the sequence of mathematical decisions inside the problem rather than converting it into a list of procedural instructions.

Prefer concise prompts such as:

- `What is ...? Show how you worked it out.`
- `Which ...? Explain your choice using the mathematics in the diagram.`
- `What must the missing value be?`

Avoid prompts that prescribe the pathway, such as:

- `First convert ..., then compare ..., then ...`
...
Reject or replace a question when:

- difficulty comes from a new classification, proof or exhaustive-search convention;
- a person-claim critique is used merely to manufacture reasoning;
- card sorting, digit banks or `find every solution` tasks have not been practised or approved;
- instructions reveal or sequence the strategy;
...
1. Is Q7 one clear main problem rather than a bundle of unrelated actions?
2. Is Q8 one clear extension-level problem rather than an unfamiliar puzzle protocol?
